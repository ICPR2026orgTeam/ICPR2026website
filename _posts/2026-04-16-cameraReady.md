...
<p>
    The upload period will open on 
    <b class="text-info">April 20</b> 
    and close on 
    <b class="text-info">May 4</b>.
    See details on camera-ready submission in the 
    <a href="{{ site.baseurl }}/news.html#FAQ-cameraready">FAQ – Camera-ready</a>.
</p>
